-- Run this once in the Supabase SQL Editor if the migration has not been applied:
-- https://supabase.com/dashboard/project/_/sql/new
--
-- Creates the storage bucket + policies needed for service-record before/after photos.
